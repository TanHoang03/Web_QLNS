<%@ Page Title="" Language="C#" MasterPageFile="~/ql.Master" AutoEventWireup="true" CodeBehind="qlNhanVien.aspx.cs" Inherits="Web_QLNS.qlNhanVien" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="noiDung" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover " DataKeyNames="MaNV" DataSourceID="dsNhanVien" >
        <Columns>
